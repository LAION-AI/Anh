...
def translate_english_to_swedish(english_text):
    ...
    print(colored("The Swedish translation is:", "green"), colored(swedish_text, "yellow"))
    return swedish_text
    ...
    with jsonlines.open(input_file) as reader, \
        ...
        for line in reader:
            ...
            for dialogue_pair in dialogue_pairs:
                if dialogue_pair=='':#the first occurrence of User: is removed by the split
                    continue
                try:
                    user_text = dialogue_pair.split('\nAssistant:')[0]
                    assistant_response =dialogue_pair.split('\nAssistant:')[1]
                    print(colored("\nThe user text is:", "green"), colored(user_text, "blue"))
                except:
                ...
                print(colored("The assistant response is:", "green"), colored(assistant_response, "red"))
                assistant_response_translated =  translate_english_to_swedish(assistant_response)
                ...
                thread.append({
                    'text': assistant_response_translated,
                    'role': 'assistant'
                })
            ...
            print(colored("The translated line is:", "green"), colored(new_line, "magenta"))
            print(colored("\n******************\n", "black"))
...
if __name__ == "__main__":
    translate_jsonl('oa_v3_fixed_plus_safety.jsonl', 'LAION-multilingual-bot-swedish.jsonl','corrupt_lines.txt')
